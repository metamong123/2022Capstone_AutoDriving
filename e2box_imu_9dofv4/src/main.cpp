...
void publishImuData(void)
{
    ...
    if(!m_e2box_imu.data_acquisition){
        ...
        */
        ...
        mag.magnetic_field.x=m_e2box_imu.m_dMagnet[0];
        mag.magnetic_field.y=m_e2box_imu.m_dMagnet[1];
        mag.magnetic_field.z=m_e2box_imu.m_dMagnet[2];
...
int main(int argc, char *argv[])
{
    ...
    mag_pub = nh.advertise<sensor_msgs::MagneticField>("imu/mag", 100);
