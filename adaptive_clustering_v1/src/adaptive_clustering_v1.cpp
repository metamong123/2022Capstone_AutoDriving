...
#include "adaptive_clustering_v1/ClusterArray.h"
...
void pointCloudCallback(const sensor_msgs::PointCloud2::ConstPtr& ros_pc2_in) {
  ...
  adaptive_clustering_v1::ClusterArray cluster_array;
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "adaptive_clustering_v1");
  ...
  cluster_array_pub_ = private_nh.advertise<adaptive_clustering_v1::ClusterArray>("clusters", 100);
  ...
  private_nh.param<float>("z_axis_min", z_axis_min_, -0.4);
