...
MFM_DLL_API void mfmDllVersion(struct XsVersion* version);
MFM_DLL_API void mfmDllPath(struct XsString* path);
#ifdef __cplusplus
#ifndef SWIG
MFM_DLL_API void mfmSetDebugLogger(Journaller * journaller);
#endif
#endif
