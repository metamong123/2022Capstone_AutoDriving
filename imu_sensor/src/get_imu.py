...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if (len(IMU_message)>55):
            ...
            imu.linear_acceleration.x = accel[0]   #gravity eliminate
            imu.linear_acceleration.y = accel[1]   #gravity eliminate
            imu.linear_acceleration.z = accel[2]   #gravity eliminate
