...
if __name__ == "__main__":
	...
	with open(path_map + "/src/kcity/parking_v1_0.pkl", "rb") as f: #parking
		nodes['parking']= pickle.load(f)
	nodes['parking'][1]={}
	nodes['parking'][1]=nodes['parking'][0]
	with open(path_map + "/src/kcity/parking_v1_1.pkl", "rb") as f: #parking
		park_2= pickle.load(f)
		nodes['parking'][2]=park_2[0]
	nodes['parking'][3]={}
	nodes['parking'][3]=nodes['parking'][2]
	with open(path_map + "/src/kcity/parking_v1_2.pkl", "rb") as f: #parking
		park_4= pickle.load(f)
		nodes['parking'][4]=park_4[0]
	nodes['parking'][5]={}
	nodes['parking'][5]=nodes['parking'][4]
	with open(path_map + "/src/kcity/parking_v1_3.pkl", "rb") as f: #parking
		park_6= pickle.load(f)
		nodes['parking'][6]=park_6[0]
	nodes['parking'][7]={}
	nodes['parking'][7]=nodes['parking'][6]
	with open(path_map + "/src/kcity/parking_v1_4.pkl", "rb") as f: #parking
		park_8= pickle.load(f)
		nodes['parking'][8]=park_8[0]
	nodes['parking'][9]={}
	nodes['parking'][9]=nodes['parking'][8]
	with open(path_map + "/src/kcity/parking_v1_5.pkl", "rb") as f: #parking
		park_10= pickle.load(f)
	...
	# with open("/home/mds/catkin_ws/src/2022Capstone_AutoDriving/frenet_frame-and-stanley-in-rviz/src/map_server/src/parking1_.pkl", "rb") as f: #parking
	# 	nodes['parking']= pickle.load(f)
	# nodes['parking'][1]={}
	# nodes['parking'][1]=nodes['parking'][0]
	...
	while not rospy.is_shutdown():
		...
		if (mode == 'global') and ((my_wp[mode] >= 182) and (my_wp[mode] < 185)): ################parking mode 시작 웨이포인트 넣기
			# print("11111!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
			prev_park_ind=0
