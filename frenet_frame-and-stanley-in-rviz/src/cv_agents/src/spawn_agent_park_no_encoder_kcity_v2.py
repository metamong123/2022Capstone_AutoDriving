...
if __name__ == "__main__":
	...
	with open(path_map + "/src/kcity/parking_v2_0.pkl", "rb") as f: #parking
		nodes['parking']= pickle.load(f)
	nodes['parking'][1]={}
	nodes['parking'][1]=nodes['parking'][0]
	with open(path_map + "/src/kcity/parking_v2_1.pkl", "rb") as f: #parking
		park_2= pickle.load(f)
		nodes['parking'][2]=park_2[0]
	nodes['parking'][3]={}
	nodes['parking'][3]=nodes['parking'][2]
	with open(path_map + "/src/kcity/parking_v2_2.pkl", "rb") as f: #parking
		park_4= pickle.load(f)
		nodes['parking'][4]=park_4[0]
	nodes['parking'][5]={}
	nodes['parking'][5]=nodes['parking'][4]
	with open(path_map + "/src/kcity/parking_v2_3.pkl", "rb") as f: #parking
		park_6= pickle.load(f)
		nodes['parking'][6]=park_6[0]
	nodes['parking'][7]={}
	nodes['parking'][7]=nodes['parking'][6]
	with open(path_map + "/src/kcity/parking_v2_4.pkl", "rb") as f: #parking
		park_8= pickle.load(f)
		nodes['parking'][8]=park_8[0]
	nodes['parking'][9]={}
	nodes['parking'][9]=nodes['parking'][8]
	with open(path_map + "/src/kcity/parking_v2_5.pkl", "rb") as f: #parking
		park_10= pickle.load(f)
	...
	while not rospy.is_shutdown():
		...
		if opt_ind == -1: ## No solution!
			...
			# 		fin_wp = [my_wp[mode], link_ind[mode]]
				...
				# 	fin_wp = [my_wp['global'], link_ind['global']],my_wp['global']
				# 	mode = 'global'
				# else:
				# 	move_mode='finish'
				# 	print("finish!")
