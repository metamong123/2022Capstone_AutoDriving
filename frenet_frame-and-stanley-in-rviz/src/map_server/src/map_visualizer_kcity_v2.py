...
if __name__ == "__main__":
	...
	parking1_file = path + "/src/kcity/parking_v2_0.pkl"
	parking2_file = path + "/src/kcity/parking_v2_1.pkl"
	parking3_file = path + "/src/kcity/parking_v2_2.pkl"
	parking4_file = path + "/src/kcity/parking_v2_3.pkl"
	parking5_file = path + "/src/kcity/parking_v2_4.pkl"
	parking6_file = path + "/src/kcity/parking_v2_5.pkl"
