...
if __name__ == "__main__":
	...
	parking1_file = path + "/src/kcity/parking_v3_0.pkl"
	parking2_file = path + "/src/kcity/parking_v3_1.pkl"
	parking3_file = path + "/src/kcity/parking_v3_2.pkl"
	parking4_file = path + "/src/kcity/parking_v3_3.pkl"
	parking5_file = path + "/src/kcity/parking_v3_4.pkl"
	parking6_file = path + "/src/kcity/parking_v3_5.pkl"
