...
bool operator==(const ::object_msgs::Prediction_<ContainerAllocator1> & lhs, const ::object_msgs::Prediction_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.id == rhs.id &&
    lhs.n_predictions == rhs.n_predictions &&
    lhs.dt == rhs.dt &&
