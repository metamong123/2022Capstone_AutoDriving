...
bool operator==(const ::object_msgs::trajectory_<ContainerAllocator1> & lhs, const ::object_msgs::trajectory_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.id == rhs.id &&
    lhs.mask == rhs.mask &&
    lhs.valid_sequence_num == rhs.valid_sequence_num &&
