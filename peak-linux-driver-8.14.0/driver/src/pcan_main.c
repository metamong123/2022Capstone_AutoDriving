...
int pcan_chardev_rx(struct pcandev *dev, struct pcanfd_rxmsg *rx)
{
	 ...
	 * received by packets.
	 */
	return pcan_fifo_put_ex(&dev->readFifo, rx,
...
{
	return pcan_fifo_get_ex(&dev->writeFifo, tx, NULL, NULL);
}
